...
// SchemaAPI - Schema API - Core Schema related endpoints
type SchemaAPI struct {
	sdkConfiguration sdkConfiguration
}

func newSchemaAPI(sdkConfig sdkConfiguration) *SchemaAPI {
	return &SchemaAPI{
		sdkConfiguration: sdkConfig,
	}
}

// GetSchemaInfoList - Searches SchemaInfo repository
...
func (s *SchemaAPI) GetSchemaInfoList(ctx context.Context, request operations.GetSchemaInfoListRequest, opts ...operations.Option) (*operations.GetSchemaInfoListResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/schema")
	if err != nil {
	...
	res := &operations.GetSchemaInfoListResponse{
...
// UpsertSchema - Creates/Updates a schema in development status
...
func (s *SchemaAPI) UpsertSchema(ctx context.Context, request components.SchemaRequest, opts ...operations.Option) (*operations.UpsertSchemaResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	res := &operations.UpsertSchemaResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
// CreateSchema - Adds a schema to the schema repository.
...
func (s *SchemaAPI) CreateSchema(ctx context.Context, request components.SchemaRequest, opts ...operations.Option) (*operations.CreateSchemaResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// GetSchema - Gets schema from the schema repository.
// Retrieve a schema using its system defined id. Required roles:  `service.schema-service.viewers` groups to get the schema.
func (s *SchemaAPI) GetSchema(ctx context.Context, id string, opts ...operations.Option) (*operations.GetSchemaResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/schema/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
